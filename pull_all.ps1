...
$Repos = @("Schaltzentrale", "Termindokumentierer", "Assistenz", "Workflow Builder", "SocialMediaBuilder", "GuestAI", "HomeAssistant", "Researcher", "Immobewertung", "KundenAB", "PropertyDesk", "DropboxCheck", "ZeitenAbgleich", "AgentischesArbeiten", "MetaAdsAgent", "ErrorTicketRouter", "VoiceBridge", "vault", "personal_branding")
