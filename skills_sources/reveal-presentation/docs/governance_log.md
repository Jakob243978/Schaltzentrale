# Governance-Log — Skill "reveal-presentation"
...
**Entscheidung:** Der Skill "reveal-presentation" bekommt eine eigene SDD+PO-Initialisierung
(PROJECT_VISION, sdd-config, po-config, tickets/, adr/, governance_log, CHANGELOG,
ROADMAP, CLAUDE.md). Die bisher zentral in `skill_dev/docs/tickets/reveal-presentation/` liegenden
