# reveal-presentation — self-contained SDD+PO-Skill-Projekt

Dieser Skill baut single-file reveal.js-Praesentationen aus Research-Content (Speaker-Notes, zwei Style-Modi). Seit dem Dezentralisierungs-Umbau (2026-07-12) ist er
...
> `~/.claude/skills/reveal-presentation/` via `setup.ps1` (robocopy /MIR) der Schaltzentrale.
...
SDD-Config: `docs/sdd-config.yaml` (`manual_verify_required: false` — headless Methodik-/Tooling-Skill). Hinweis: Doc-/Tooling-Skill — Visual-Review statt pytest-Suite.
