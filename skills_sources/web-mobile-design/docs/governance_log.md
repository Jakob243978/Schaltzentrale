# Governance-Log — Skill "web-mobile-design"
...
**Entscheidung:** Der Skill "web-mobile-design" bekommt eine eigene SDD+PO-Initialisierung
(PROJECT_VISION, sdd-config, po-config, tickets/, adr/, governance_log, CHANGELOG,
ROADMAP, CLAUDE.md). Die bisher zentral in `skill_dev/docs/tickets/web-mobile-design/` liegenden
