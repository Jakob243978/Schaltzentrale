# po-skill — self-contained SDD+PO-Skill-Projekt

Dieser Skill ist der Product-Owner-Counterpart zum agile-sdd-skill (Vision-Hygiene, RICE-Priorisierung, Outcome-Review). Seit dem Dezentralisierungs-Umbau (2026-07-12) ist er
...
> `~/.claude/skills/po-skill/` via `setup.ps1` (robocopy /MIR) der Schaltzentrale.
...
SDD-Config: `docs/sdd-config.yaml` (`manual_verify_required: false` — headless Methodik-/Tooling-Skill). Hinweis: Doc-/Methodik-Skill — keine pytest-Suite; Verifikation via Review.
