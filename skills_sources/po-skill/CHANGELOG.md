...
### Technical
- Skill "po-skill" (Product-Owner-Counterpart zum agile-sdd-skill) als eigenstaendiges SDD+PO-Projekt initialisiert:
...
- 4 bestehende SKILL-Tickets aus `skill_dev/docs/tickets/po-skill/` per `git mv`
