...
**Entscheidung:** Der Skill "po-skill" bekommt eine eigene SDD+PO-Initialisierung
(PROJECT_VISION, sdd-config, po-config, tickets/, adr/, governance_log, CHANGELOG,
ROADMAP, CLAUDE.md). Die bisher zentral in `skill_dev/docs/tickets/po-skill/` liegenden
