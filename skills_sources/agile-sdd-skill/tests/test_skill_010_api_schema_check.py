...
Ausfuehrung (PowerShell):
    ...
    python -m pytest skills_sources\\agile-sdd-skill\\tests\\test_skill_010_api_schema_check.py -v
"""
...
# Seit 2026-07-12 liegt dieser Test IM Skill: skills_sources/agile-sdd-skill/tests/
# AGILE_SDD = Skill-Root (eine Ebene ueber tests/).
AGILE_SDD = Path(__file__).resolve().parent.parent
SKILLS_SOURCES = AGILE_SDD.parent           # <Schaltzentrale>/skills_sources/
SCHALT_ROOT = SKILLS_SOURCES.parent          # <Schaltzentrale>/
