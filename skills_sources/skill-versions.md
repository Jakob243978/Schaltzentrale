...
> Verschoben von `skill_dev/docs/skill-versions.md` nach
> `skills_sources/skill-versions.md` (`git mv`). Portfolio-weite Rollback-Registry
> ueber alle Skill-Sources. Rollback-Befehle (`git checkout <hash> --
> skills_sources/<skill>/`) bleiben gueltig — der Skill-Code liegt weiterhin dort.
