...
> skill_dev-Aufloesung dem **agile-sdd-skill** zugeordnet (primaer betroffen:
> agile-sdd-Versionierung). **Tangiert auch po-skill** (v0.1-Eintrag). Die
> `skill-versions.md`-Registry liegt jetzt unter `skills_sources/skill-versions.md`
> (nicht mehr `skill_dev/docs/`).
